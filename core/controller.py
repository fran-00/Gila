...
class Controller(QObject):
    ...
    def __init__(self, view, model, manager, sidebar, thread):
        super().__init__()
        ...
        self.controller_signal_to_manager.connect(manager.handle_received_signal)
        self.controller_signal_to_sidebar.connect(sidebar.handle_received_signal)
